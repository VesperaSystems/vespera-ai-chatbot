  ...
  return (
    <div className="min-h-screen bg-background px-4 py-8 text-foreground md:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="flex flex-col gap-4 border-b border-[rgba(110,255,225,0.16)] pb-6 md:flex-row md:items-end md:justify-between">
          <div>
            <div className="hud-label">Local Display Config</div>
            <h1 className="mt-3 text-3xl font-semibold tracking-[0.08em] text-[rgba(235,251,255,0.96)] md:text-4xl">
              Tune the wall.
            </h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-[rgba(215,251,255,0.64)]">
              This panel controls the local graph presentation only. It is the operator surface for what the room sees on
              <span className="px-1 text-[rgba(215,251,255,0.86)]">vespera.systems</span>
              when the display is in full-screen mode.
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <Button asChild variant="outline" className="border-[rgba(110,255,225,0.18)] bg-transparent text-foreground hover:bg-accent/60">
              <Link href="/">Back to graph</Link>
            </Button>
            <Button asChild className="bg-[rgba(110,255,225,0.14)] text-[rgba(235,251,255,0.94)] hover:bg-[rgba(110,255,225,0.2)]">
          ...
          <section className="mission-panel">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              <div className="space-y-2">
                <label htmlFor="mission-focus" className="tactical-text text-[10px] uppercase tracking-[0.28em] text-[rgba(215,251,255,0.6)]">Sector Focus</label>
              ...
              <div className="space-y-2">
                <label htmlFor="mission-time-window" className="tactical-text text-[10px] uppercase tracking-[0.28em] text-[rgba(215,251,255,0.6)]">Time Horizon</label>
              ...
              <div className="space-y-2">
                <label htmlFor="mission-density" className="tactical-text text-[10px] uppercase tracking-[0.28em] text-[rgba(215,251,255,0.6)]">Network Density</label>
              ...
              <div className="space-y-2">
                <label htmlFor="mission-motion" className="tactical-text text-[10px] uppercase tracking-[0.28em] text-[rgba(215,251,255,0.6)]">Motion Level</label>
          ...
          <section className="mission-panel">
            ...
            <div className="mt-6 grid gap-6 md:grid-cols-2">
              <div className="space-y-2 md:col-span-2">
                <label htmlFor="mission-palette" className="tactical-text text-[10px] uppercase tracking-[0.28em] text-[rgba(215,251,255,0.6)]">Palette</label>
              ...
              <div className="flex items-center justify-between border border-[rgba(110,255,225,0.14)] px-4 py-3">
                <div>
                  <div className="text-sm text-[rgba(235,251,255,0.94)]">Entity Labels</div>
                  <div className="text-xs text-[rgba(215,251,255,0.56)]">Show name callouts on the graph.</div>
                </div>
              ...
              <div className="flex items-center justify-between border border-[rgba(110,255,225,0.14)] px-4 py-3">
                <div>
                  <div className="text-sm text-[rgba(235,251,255,0.94)]">Signal Ripples</div>
                  <div className="text-xs text-[rgba(215,251,255,0.56)]">Pulse notable events through the graph.</div>
                </div>
              ...
              <div className="flex items-center justify-between border border-[rgba(110,255,225,0.14)] px-4 py-3">
                <div>
                  <div className="text-sm text-[rgba(235,251,255,0.94)]">Timeline Guides</div>
                  <div className="text-xs text-[rgba(215,251,255,0.56)]">Keep the temporal bands visible.</div>
                </div>
              ...
              <div className="flex items-center justify-between border border-[rgba(110,255,225,0.14)] px-4 py-3">
                <div>
                  <div className="text-sm text-[rgba(235,251,255,0.94)]">Signal Headlines</div>
                  <div className="text-xs text-[rgba(215,251,255,0.56)]">Keep operator summaries visible.</div>
                </div>
        ...
        <section className="mission-panel mt-6">
          ...
          <div className="mt-5 flex flex-wrap gap-3">
            <Button onClick={() => persist(defaultMissionControlConfig)} variant="outline" className="border-[rgba(110,255,225,0.18)] bg-transparent text-foreground hover:bg-accent/60">
              Reset defaults
            </Button>
            <Button asChild className="bg-[rgba(110,255,225,0.14)] text-[rgba(235,251,255,0.94)] hover:bg-[rgba(110,255,225,0.2)]">
